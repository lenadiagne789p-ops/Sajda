...
class InvocationListPage extends StatefulWidget {
  final InvocationCategory category;
  const InvocationListPage({super.key, required this.category});

  @override
  State<InvocationListPage> createState() => _InvocationListPageState();
}

class _InvocationListPageState extends State<InvocationListPage> {
              ...
              Expanded(
                child: Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => _DhikrCard(item: _filtered[index]),
                  ),
                ),
              ),
            ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${widget.category.items.length} invocations',
